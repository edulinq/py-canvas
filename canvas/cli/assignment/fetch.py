...
def run_cli(assignment = None, table = canvas.cli.common.DEFAULT_TABLE, skip_headers = DEFAULT_SKIP_HEADERS,
        skip_description = DEFAULT_SKIP_DESCRIPTION, output_json = canvas.cli.common.DEFAULT_JSON, **kwargs):
    raw_assignments = []
